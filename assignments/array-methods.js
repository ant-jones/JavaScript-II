...
let fullNames = [];
function getName(arrayItem){
fullNames.push(arrayItem.first_name + " " + arrayItem.last_name )
}
...
let firstNamesAllCaps = [];
  ...
  firstNamesAllCaps = runners.map(function(arrItem){
...
let runnersLargeSizeShirts = [];
runnersLargeSizeShirts = runners.filter(function(arrayItem){
    return arrayItem.shirt_size === "L";
})
console.log(runnersLargeSizeShirts);
